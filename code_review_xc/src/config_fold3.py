...
# ========================= Dataset Configs ==========================
parser.add_argument('--train-record-pattern', type=str, default='../save/data/pairwise_train_fold_2.tfrecords')
parser.add_argument('--pretrain-record-pattern', type=str, default='../save/data/train_pointwise.tfrecords')
parser.add_argument('--val-record-pattern', type=str, default='../save/data/pairwise_val_fold_2.tfrecords')
...
parser.add_argument('--output-json', type=str, default='result_fold3.json')
parser.add_argument('--output-zip', type=str, default='result_asr_text_fold3_tag12000_testb.zip')
...
parser.add_argument('--savedmodel-path', type=str, default='../save/ft_fold3/20211001')
parser.add_argument('--ckpt-file', type=str, default='../save/ft_fold3/20211001/ckpt-150000')
