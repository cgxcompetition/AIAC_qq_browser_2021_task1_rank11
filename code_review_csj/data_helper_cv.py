...
def create_datasets(args):
    train_files = glob.glob(args.train_kfold_file)
    val_files = glob.glob(args.val_kfold_file)

    parser = FeatureParser(args)
    train_dataset = parser.create_dataset(train_files, training=True, batch_size=args.batch_size)
    val_dataset = parser.create_dataset(val_files, training=False, batch_size=args.batch_size)
