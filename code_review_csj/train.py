...
def train(args):
    ...
    def cal_loss(query_labels, candidate_labels, score, predictions, query_label_predictions, candidate_label_predictions):
        score = tf.nn.sigmoid(5 * score)
        return loss_object(score, predictions) + loss_object1(query_labels, query_label_predictions) + loss_object1(candidate_labels, candidate_label_predictions)
