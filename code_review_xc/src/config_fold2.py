...
# ========================= Dataset Configs ==========================
parser.add_argument('--train-record-pattern', type=str, default='../save/data/pairwise_train_fold_1.tfrecords')
parser.add_argument('--pretrain-record-pattern', type=str, default='../save/data/train_pointwise.tfrecords')
parser.add_argument('--val-record-pattern', type=str, default='../save/data/pairwise_val_fold_1.tfrecords')
...
parser.add_argument('--output-json', type=str, default='result_fold2.json')
parser.add_argument('--output-zip', type=str, default='result_asr_text_fold2_tag12000_testb.zip')
...
parser.add_argument('--savedmodel-path', type=str, default='../save/ft_fold2/20211001')
parser.add_argument('--ckpt-file', type=str, default='../save/ft_fold2/20211001/ckpt-150000')
